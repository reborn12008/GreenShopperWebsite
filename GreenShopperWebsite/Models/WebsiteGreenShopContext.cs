...
{
    public partial class WebsiteGreenShopContext : DbContext
    {
        public WebsiteGreenShopContext()
        {
        }

        public WebsiteGreenShopContext(DbContextOptions<WebsiteGreenShopContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<ShoplistProduct> ShoplistProducts { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=WebsiteGreenShop;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ShoplistProduct>(entity =>
            {
